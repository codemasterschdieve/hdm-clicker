...
import hdm.wi.clicker.server.db.*;
import hdm.wi.clicker.shared.Controller;
 ...
 * 
 * @see Controller
 * @see com.ControllerAsync.stundenplantool2.shared.VerwaltungAsync
...
public class ControllerImpl extends RemoteServiceServlet implements Controller {
	...
	/**
	   ...
	   */
	public TeacherMapper lecturerMapper = TeacherMapper.lecturerMapper();
	...
	public ResultMapper resultsMapper = ResultMapper.resultsMapper();
	public QuizCacheMapper quizPackageMapper = QuizCacheMapper.quizPackageMapper();
	 ...
	 * 			weitergereicht. 
	 */
	public Vector<Teacher> getTeacher(Teacher lecturer) throws RuntimeException {
	 ...
	 * 			weitergereicht.
	 */
	public Teacher editTeacher(Teacher lecturer) throws RuntimeException {
		if (isAdmin || signedInLecturer != null) {
	 ...
	 * 			weitergereicht. 
	 */
	public void deleteTeacher(Teacher lecturer) throws RuntimeException {
		if (!isAdmin) {
			throw new RuntimeException("Berechtigung nicht ausreichend");
		}
	 ...
	 */
	public Teacher createTeacher(String user, String password, String firstName, String name) throws RuntimeException {
		if (!isAdmin) {
			throw new RuntimeException("Berechtigung nicht ausreichend");
		}
	 ...
	 */
	public boolean authenticateTeacher(String user, String password) throws RuntimeException {
	 ...
	 * 			welche ebenfalls an den Client weitergereicht werden 
	 */
	public Question createQuestion(String body, String answer1, String answer2, String answer3, String answer4, int severity, int categoryID) throws RuntimeException {
		if (signedInLecturer != null) {
	 ...
	 * 			weitergereicht. 
	 */
	public Vector<Question> getAllQuestionsByCategory(Category cat) throws RuntimeException {
		if (signedInLecturer != null) {
	 ...
	 * 			weitergereicht. 
	 */
	public Vector<Question> getAllQuestionsByCategoryAndDifficulty(Category cat, int severity) throws RuntimeException {
		if (signedInLecturer != null) {
	 ...
	 * 			weitergereicht.
	 */
	public Quiz editQuiz(Quiz quiz, Vector<Question> vq) throws RuntimeException {
		if (signedInLecturer != null) {
	 ...
	 * 			weitergereicht. 
	 */
	public Vector<Quiz> getAllQuizzByTeacherAndStartingdate(int date) throws RuntimeException {
		if (signedInLecturer != null) {
	 ...
	 */
	public void loginStudent(String ptc) throws RuntimeException {
	...
	public Vector<Boolean> getMissingResults(Vector<Result> vr) throws RuntimeException {
