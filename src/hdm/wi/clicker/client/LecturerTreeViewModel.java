...
public class LecturerTreeViewModel implements TreeViewModel {
	 ...
	 */
	private ListDataProvider<Teacher> lecturerDataProvider = null;
	 ...
	 */
	public LecturerTreeViewModel(ControllerAsync verwaltungA) {
		...
		selectionModel.addSelectionChangeHandler(new SelectionChangeEvent.Handler() {
			...
			public void onSelectionChange(SelectionChangeEvent event) {
				 ...
				 */
					...
					verwaltung.getloggedinTeacher(new AsyncCallback<Teacher>() {
	...
	public <T> NodeInfo<?> getNodeInfo(T value) {
		...
		if (value instanceof String && (String) value == "Quizze") {
			...
			verwaltung.getAllQuizByTeacher(new AsyncCallback<Vector<Quiz>>() {
				public void onFailure(Throwable caught) {
					Window.alert(caught.getMessage());
				}
