...
public class PlayQuizFormMobile extends ScrollPanel {
	 ...
	 */	
	public PlayQuizFormMobile(ControllerAsync verwaltungA) {
		...
		for (Integer bo : bOrder) {
			switch (bo) {
				case 0:
					...
					break;
				case 1:
					buttonVector.add(createButton(questionVector.elementAt(qOrder.elementAt(qPointer)).getAnswer2Text()));
					carrierPanel.add(buttonVector.elementAt(buttonVector.size()-1));
					break;
				case 2:
					buttonVector.add(createButton(questionVector.elementAt(qOrder.elementAt(qPointer)).getAnswer3Text()));
					carrierPanel.add(buttonVector.elementAt(buttonVector.size()-1));
					break;
				case 3:
					buttonVector.add(createButton(questionVector.elementAt(qOrder.elementAt(qPointer)).getAnswer4Text()));
					carrierPanel.add(buttonVector.elementAt(buttonVector.size()-1));
					break;
			}
		}
