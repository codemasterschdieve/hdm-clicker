...
public class ReportForm extends VerticalPanel {
	 ...
	 */	
	public ReportForm(ControllerAsync verwaltungA) {
	...
	public void ladenStartdaten() {
		verwaltung.getQuizDatasByTeacher(new AsyncCallback<Vector<Integer>>() {
	...
	public void generatePieCharts() {
		...
		verwaltung.getInfographByQuiz(quizVectorLB.elementAt(quizBox.getSelectedIndex()), new AsyncCallback<Vector<InfoGraph>>() {
	...
	public void loadCSVData() {
		verwaltung.getCSVDataByQuiz(quizVectorLB.elementAt(quizBox.getSelectedIndex()), new AsyncCallback<String>() {
