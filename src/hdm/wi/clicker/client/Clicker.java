...
public class Clicker implements EntryPoint {
	 ...
	 */
	private final ControllerAsync verwaltung = GWT.create(Controller.class);
	...
	public void initDBCon() {
		verwaltung.openDBConnection(new AsyncCallback<Void>() {
	...
	public void checkQuizzes() {
		verwaltung.checkAllQuiz(new AsyncCallback<Void>() {
	...
	public void addClickHandlerToADBButton() {
		authDBButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				verwaltung.authenticateAdministrator(authDBPWTB.getText(), new AsyncCallback<Boolean>() {
	...
	public void addClickHandlerToLDBButton() {
		authDBButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				verwaltung.authenticateTeacher(authDBUserTB.getText(), authDBPWTB.getText(), new AsyncCallback<Boolean>() {
		...
		authDBButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				*/
				...
				verwaltung.loginStudent("lz006", new AsyncCallback<Void>() {
