...
public class QuestionForm extends VerticalPanel {
	 ...
	 */	
	public QuestionForm(ControllerAsync verwaltungA) {
	...
	public void fillForm() {
		this.questionTextArea.setText(this.shownQuestion.getQuestionText());
		this.answer1TextArea.setText(this.shownQuestion.getAnswer1());
		this.answer2TextArea.setText(this.shownQuestion.getAnswer2Text());
		this.answer3TextArea.setText(this.shownQuestion.getAnswer3Text());
		this.answer4TextArea.setText(this.shownQuestion.getAnswer4Text());
	}
	...
	public void aendernMaske() {
		...
		speichernAnlegenButton.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				shownQuestion.setAnswer3Text(answer3TextArea.getText());
				shownQuestion.setAnswer4Text(answer4TextArea.getText());
				shownQuestion.setDifficulty(severityListBox.getSelectedIndex() + 1);
				shownQuestion.setCategoryID(cVector.elementAt(categoryListBox.getSelectedIndex()).getId());
				
				
				verwaltung.editQuestion(shownQuestion, new AsyncCallback<Question>() {
					public void onFailure(Throwable caught) {
						Window.alert(caught.getMessage());

						verwaltung.getQuestion(shownQuestion, new AsyncCallback<Vector<Question>>() {
							public void onFailure(Throwable caught) {
		...
		loeschenButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				verwaltung.deleteQuestion(shownQuestion, new AsyncCallback<Void>() {
					public void onFailure(Throwable caught) {
						Window.alert(caught.getMessage());
						speichernAnlegenButton.setEnabled(true);
						loeschenButton.setEnabled(true);
	...
	public void anlegenMaske() {
		...
		speichernAnlegenButton.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				verwaltung.createQuestion(questionTextArea.getText(), answer1TextArea.getText(), answer2TextArea.getText(), answer3TextArea.getText(), 
