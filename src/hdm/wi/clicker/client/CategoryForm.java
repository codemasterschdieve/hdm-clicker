...
public class CategoryForm extends VerticalPanel {
	 ...
	 */	
	public CategoryForm(ControllerAsync verwaltungA) {
	...
	public void aendernMaske() {
		...
		speichernAnlegenButton.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				verwaltung.editCategory(shownCategory, new AsyncCallback<Category>() {
					public void onFailure(Throwable caught) {
						Window.alert(caught.getMessage());

						verwaltung.getCategory(shownCategory, new AsyncCallback<Vector<Category>>() {
							public void onFailure(Throwable caught) {
								Window.alert(caught.getMessage());
		...
		loeschenButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				verwaltung.deleteCategory(shownCategory, new AsyncCallback<Void>() {
					public void onFailure(Throwable caught) {
						Window.alert(caught.getMessage());
						speichernAnlegenButton.setEnabled(true);
						loeschenButton.setEnabled(true);
	...
	public void ladenQuestions() {
		verwaltung.getAllQuestionsByCategory(shownCategory, new AsyncCallback<Vector<Question>>() {
			...
			for (Question q : questionVector) {
				...
				loeschenButton.addClickHandler(new ClickHandler() {
					public void onClick(ClickEvent event) {
						...
						verwaltung.deleteQuestion(questionVector.elementAt(rowIndex - 1), new AsyncCallback<Void>() {
	...
	public void anlegenMaske() {
		...
		speichernAnlegenButton.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				verwaltung.createCategory(catTextBox.getText(), new AsyncCallback<Category>() {
					public void onFailure(Throwable caught) {
						Window.alert(caught.getMessage());
						speichernAnlegenButton.setEnabled(true);
					}
