...
public class LecturerForm extends VerticalPanel {
	 ...
	 */	
	public LecturerForm(ControllerAsync verwaltungA) {
	 ...
	 */
	public void setShownLecturer(Teacher lecturer) {
	...
	public void aendernMaske() {
		...
		speichernAnlegenButton.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				shownLecturer.getLastname(nameTextBox.getText());
				
				verwaltung.editTeacher(shownLecturer, new AsyncCallback<Teacher>() {
					public void onFailure(Throwable caught) {
						Window.alert(caught.getMessage());

						verwaltung.getTeacher(shownLecturer, new AsyncCallback<Vector<Teacher>>() {
							public void onFailure(Throwable caught) {
							 ...
							 *  aufgesetzt
							 */
							public void onSuccess(Vector<Teacher> result) {
								if (atvm != null) {
		...
		loeschenButton.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				verwaltung.deleteTeacher(shownLecturer, new AsyncCallback<Void>() {
					public void onFailure(Throwable caught) {
						Window.alert(caught.getMessage());
						speichernAnlegenButton.setEnabled(true);
						loeschenButton.setEnabled(true);
	...
	public void anlegenMaske() {
		...
		speichernAnlegenButton.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				verwaltung.createTeacher(userTextBox.getText(), passwortTextBox.getText(), firstnameTextBox.getText(), nameTextBox.getText(), new AsyncCallback<Teacher>() {
					public void onFailure(Throwable caught) {
						Window.alert(caught.getMessage());
						speichernAnlegenButton.setEnabled(true);
					}
